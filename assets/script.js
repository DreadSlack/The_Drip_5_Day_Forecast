...
var weatherApiKey = '966d9e3bb7fcf8e9e293954ae2c44796';

var searchForm = document.querySelector('#search-form');
var searchInput = document.querySelector('#search-input');
var todayConatiner = document.querySelector('#today');
...
function renderCurrentWeather (city, weather){
    ...
    weatherIcon.setAttribute('src', iconDescription);
    ...
    todayConatiner.innerHTML = '';
    todayConatiner.append(card);
}
...
function rednerItems(city, data){
...
searchHistoryContainer.addEventListener('click', handleSeachHistoryClick);
